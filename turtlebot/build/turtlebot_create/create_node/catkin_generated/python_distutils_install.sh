...
echo_and_run cd "/home/wojciech/turtlebot/src/turtlebot_create/create_node"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/wojciech/turtlebot/src/turtlebot_create/create_node/setup.py" \
    build --build-base "/home/wojciech/turtlebot/build/turtlebot_create/create_node" \
    install \
    $DESTDIR_ARG \
