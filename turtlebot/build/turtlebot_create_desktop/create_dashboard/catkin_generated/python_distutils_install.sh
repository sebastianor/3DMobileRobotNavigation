...
echo_and_run cd "/home/wojciech/turtlebot/src/turtlebot_create_desktop/create_dashboard"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/wojciech/turtlebot/src/turtlebot_create_desktop/create_dashboard/setup.py" \
    build --build-base "/home/wojciech/turtlebot/build/turtlebot_create_desktop/create_dashboard" \
    install \
    $DESTDIR_ARG \
